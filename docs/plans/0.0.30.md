...
- 世界内角色系统（用户创建角色卡；roleplay=用户与 bot 对话并指定 bot 扮演某个角色）
- 世界统计（访客数/角色数，持久化）
- 正典/编年史/冲突检测（最小闭环）
...
- `/character act <characterId>`：指定 bot 在本世界扮演哪个角色（roleplay 开关）
