!(function (e) {
  ...
  function a(e) {
    e &&
      ...
      document.querySelector(".sidebar").scrollBy(0, e - t));
  }
  function n() {
    requestAnimationFrame(function () {
      ...
      if (e)
        for (
          ...
          e.parentNode.classList.contains("app-sub-sidebar") &&
          !e.parentNode.classList.contains("open");
        )
        ...
        : ((function (e) {
            if (e)
              for (
                ...
                e && "sidebar-nav" !== e.className && e.parentNode;
              )
      ...
      e ||
        ((e = d(
          document.querySelector(
            '.sidebar-nav a[href="'.concat(
              decodeURIComponent(location.hash).replace(/ /gi, "%20"),
              '"]',
            ),
          ),
          "LI",
  ...
  (768 < document.documentElement.clientWidth ||
    ...
    window.addEventListener("load", function () {
      ...
      document.body.onclick = n.onclick = function (e) {
        (e.target !== document.body && e.currentTarget !== n) ||
          ("true" === localStorage.getItem(c) && l());
      };
    })),
    (function () {
      if (window.$docsify) {
      ...
      (e.doneEach(function (e, n) {
        ...
        (i(t),
          document.querySelectorAll(".sidebar-nav li").forEach(function (e) {
            e.querySelector("ul:not(.app-sub-sidebar)")
