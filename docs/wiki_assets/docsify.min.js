!(function () {
  ...
  function E(e, n) {
    ...
    for (i in e)
      -1 < n.indexOf(i) ||
        o.push(e[i] ? (z(i) + "=" + z(e[i])).toLowerCase() : z(i));
  ...
  var R = c(function (e) {
    ...
    L = c(function (e) {
      for (
        var n = e.replace(/^\//, "").split("/"), i = [], o = 0, t = n.length;
        o < t;
        o++
      ) {
        var a = n[o];
  ...
  ((I.prototype.getBasePath = function () {
    ...
    (I.prototype.getFile = function (e, n) {
      ...
      return (
        ...
        (o = r),
        (e =
          ((e = new RegExp("\\.(" + o.replace(/^\./, "") + "|html)$", "g").test(
            i,
          )
            ? i
            : /\/$/g.test(i)
  ...
  var H = (function (o) {
      ...
      return (
        o && (e.__proto__ = o),
        (((e.prototype = Object.create(o && o.prototype)).constructor =
  ...
  function ue(e) {
    ...
    if (o)
      for (var t in i)
        !u.call(i, t) ||
          (f((n = o.getAttribute("data-" + a(t)))) && (i[t] = "" === n || n));
    return (
      ...
      (i = b("#" + n)) &&
        ...
        (de = new ae({
          start: window.pageYOffset,
            ...
            Math.round(i.getBoundingClientRect().top) + window.pageYOffset - o,
          duration: 500,
        })
          .on("tick", function (e) {
      ...
      return (
            ...
            var i = n[0],
              e = (function (e, n) {
                ...
                return n
                  ...
                  .map(function (e) {
                    var n = e.match(/^\s+/);
                    return null !== n && n[0].length >= i.length
                      ? e.slice(i.length)
                      : e;
                  })
                  .join("\n");
        ...
        (e.prototype.strong = function (e, n, i) {
          ...
          if (
            o &&
            (!o[1] ||
              (o[1] && ("" === i || this.rules.inline.punctuation.exec(i))))
          ) {
            ...
            for (a.lastIndex = 0; null != (o = a.exec(n)); )
              if (
                (t = this.rules.inline.strong.middle.exec(
                  n.slice(0, o.index + 3),
                ))
              )
                return {
        ...
        (e.prototype.em = function (e, n, i) {
          ...
          if (
            ...
            for (a.lastIndex = 0; null != (o = a.exec(n)); )
              if (
                (t = this.rules.inline.em.middle.exec(n.slice(0, o.index + 2)))
              )
                return {
                  type: "em",
                  raw: e.slice(0, t[0].length),
  ...
  ((Ne.def = Ve(Ne.def)
    .replace("label", Ne._label)
    .replace("title", Ne._title)
    .getRegex()),
    (Ne.bullet = /(?:[*+-]|\d{1,9}[.)])/),
    (Ne.item = /^( *)(bull) ?[^\n]*(?:\n(?! *bull ?)[^\n]*)*/),
    ...
    (Ne.paragraph = Ve(Ne._paragraph)
      ...
      .replace("tag", Ne._tag)
      .getRegex()),
    (Ne.blockquote = Ve(Ne.blockquote)
      .replace("paragraph", Ne.paragraph)
      .getRegex()),
    (Ne.normal = De({}, Ne)),
    (Ne.gfm = De({}, Ne.normal, {
      nptable:
  ...
  ((Ze.punctuation = Ve(Ze.punctuation)
    ...
    (Ze.gfm.url = Ve(Ze.gfm.url, "i")
      .replace("email", Ze.gfm._extended_email)
      .getRegex()),
    (Ze.breaks = De({}, Ze.gfm, {
  ...
  function un(e) {
    for (var n, i = "", o = e.length, t = 0; t < o; t++)
      ((n = e.charCodeAt(t)),
        (i +=
          "&#" + (n = 0.5 < Math.random() ? "x" + n.toString(16) : n) + ";"));
    return i;
  }
  var fn = (function () {
      function i(e) {
        ...
        (i.prototype.blockTokens = function (e, n, i) {
          ...
          for (
            ...
            if ((o = this.tokenizer.space(e)))
              ((e = e.substring(o.raw.length)), o.type && n.push(o));
              ...
              for (
                e = e.substring(o.raw.length), a = o.items.length, t = 0;
                t < a;
                t++
              )
            ...
            switch ((a = e[c]).type) {
              ...
              case "table":
                ...
                for (o = a.cells.length, n = 0; n < o; n++)
                  for (
                    t = a.cells[n], a.tokens.cells[n] = [], i = 0;
                    i < t.length;
                    i++
                  )
                    ((a.tokens.cells[n][i] = []),
              ...
              case "blockquote":
                ...
                break;
              case "list":
                for (o = a.items.length, n = 0; n < o; n++)
        ...
        (i.prototype.inlineTokens = function (e, n, i, o) {
          ...
          for (; e; )
            if ((r || (c = ""), (r = !1), (t = this.tokenizer.escape(e))))
              ...
              ((e = e.substring(t.raw.length)),
                "link" === t.type &&
                  (t.tokens = this.inlineTokens(t.text, [], !0, o)),
                n.push(t));
        ...
        (e.prototype.code = function (e, n, i) {
          ...
          return (
            !this.options.highlight ||
              (null != (n = this.options.highlight(e, o)) &&
                n !== e &&
                ((i = !0), (e = n))),
            (e = e.replace(/\n$/, "") + "\n"),
            o
      ...
      return (
        ...
        (e.prototype.getNextSafeSlug = function (e, n) {
          ...
          if (this.seen.hasOwnProperty(i))
            for (
              o = this.seen[e];
              (i = e + "-" + ++o), this.seen.hasOwnProperty(i);
            );
            ...
            switch ((f = e[b]).type) {
              ...
              case "table":
                ...
                for (
                  ...
                  for (
                    c = "", a = (r = f.tokens.cells[i]).length, o = 0;
                    o < a;
                    o++
                  )
  ...
  function xn(e, i, o) {
    ...
    try {
      ...
      if (
        ...
        return (
          "<p>An error occurred:</p><pre>" + wn(e.message + "", !0) + "</pre>"
        );
      throw e;
    }
  }
  ((xn.options = xn.setOptions =
    ...
    (xn.parseInline = function (e, n) {
      ...
      try {
        ...
        return (
          n.walkTokens && xn.walkTokens(i, n.walkTokens),
          mn.parseInline(i, n)
        );
      } catch (e) {
        if (
  ...
  function An(e, i) {
    if (
      (void 0 === i && (i = '<ul class="app-sub-sidebar">{inner}</ul>'),
      !e || !e.length)
    )
      return "";
    var o = "";
    ...
    return (
      e.forEach(function (e) {
        var n = e.level || 1,
          i = n - 1;
        o < n ||
          (a[i] ? (a[i].children = (a[i].children || []).concat(e)) : t.push(e),
          (a[n] = e));
      }),
      t
    );
        ...
        g = (function (u) {
            ...
            R = {
              ...
              highlightElement: function (e, n, i) {
                ...
                (R.hooks.run("before-highlight", r),
                  r.grammar
                    ? n && u.Worker
                      ? (((n = new Worker(R.filename)).onmessage = function (
                          e,
                        ) {
                          c(e.data);
                        }),
          ...
          function C(e, n, i, o) {
            ...
            return (
              i &&
                o &&
                i[1] &&
                ((o = i[1].length), (i.index += o), (i[0] = i[0].slice(o))),
              i
            );
          }
          function a() {
          ...
          if (
            ...
            (T.stringify = function n(e, i) {
              ...
              (e &&
                (Array.isArray(e)
                  ? Array.prototype.push.apply(t.classes, e)
                  : t.classes.push(e)),
                R.hooks.run("wrap", t));
              var a,
                r = "";
        ...
        void 0 !== g &&
          ...
          g.hooks.add("before-sanity-check", function (e) {
            ...
            c.matches(d) &&
              ((e.code = ""),
              c.setAttribute(f, p),
              ((t = c.appendChild(document.createElement("CODE"))).textContent =
                "Loading…"),
              ...
              (o = function (e) {
                ...
                (o &&
                  ...
                  c.hasAttribute("data-start") ||
                    c.setAttribute("data-start", String(i + 1))),
                  (t.textContent = e),
          ...
          (n = !(g.plugins.fileHighlight = {
            highlight: function (e) {
              for (
                var n, i = (e || document).querySelectorAll(d), o = 0;
                (n = i[o++]);
              )
  ...
  function In(t, e) {
    ...
    ((this.config = t),
      ...
      (this.linkRel =
        "_blank" === this.linkTarget ? t.externalLinkRel || "noopener" : ""),
    ...
    ((this._marked = r),
      (this.compile = function (i) {
        ...
        return (
          o ? (a.toc = a.cacheTOC[n]) : (a.cacheTOC[n] = [].concat(a.toc)),
          e
        );
      }));
  }
    ...
    (In.prototype._initRenderer = function () {
      ...
      return (
        ...
        (t.code = { renderer: e }.renderer.code =
          function (e, n) {
            var i =
              Pn.languages[(n = void 0 === n ? "markup" : n)] ||
              Pn.languages.markup;
            return (
              '<pre v-pre data-lang="' +
              n +
        ...
        (t.link =
          ...
          (i.link = function (e, n, i) {
            ...
            return (
              (u = t.target || u),
              (r =
                "_blank" === u ? f.config.externalLinkRel || "noopener" : ""),
              (n = a),
              R(e) || f._matchNotCompileLink(e) || t.ignore
                ? (R(e) ||
                  ...
                  o.push(
                    0 === e.indexOf("mailto:") ? "" : 'target="' + u + '"',
                  ),
                  o.push(
                    0 !== e.indexOf("mailto:") && "" !== r
                      ? ' rel="' + r + '"'
                      : "",
                  ))
                ...
                (a.push(o.substring(r, i - 1)),
                  ...
                  a.push(
                    (t && t[n]) ||
                      function (e) {
                        return (
                          "00" + ("string" == typeof Y[n] ? e[Y[n]]() : Y[n](e))
                        ).slice(-n.length);
                      },
                  ));
              }),
  ...
  function Gn(e) {
    ...
    if (((e = e || "<h1>404 - Not found</h1>"), "Vue" in window))
      for (
        var a = 0, r = k(".markdown-section > *").filter(n);
        a < r.length;
        a += 1
      ) {
        var c = r[a];
      ...
      (2 === t &&
        ...
        d.forEach(function (e) {
          window.Vue.options.components[e] ||
            window.Vue.component(e, i.vueComponents[e]);
        }),
        !Un &&
          i.vueGlobalOptions &&
  ...
  function Wn(n, i, o, t, a, e) {
    ((n = e ? n : n.replace(/\/$/, "")),
      (n = C(n)) &&
        X(a.router.getFile(n + o) + i, !1, a.config.requestHeaders).then(
          t,
          function (e) {
            return Wn(n, i, o, t, a);
          },
    ...
    Jn = (function (e) {
      ...
      return (
        ...
        (((n.prototype = Object.create(e && e.prototype)).constructor =
          n).prototype.initPlugin = function () {
          var n = this;
            ...
            return (
              ...
              (n.prototype._bindEventOnRendered = function (e) {
                ...
                (!(function (e) {
                  ...
                  i &&
                    ...
                    y(
                      n,
                      w("div", this.compiler.header(e.innerText, 1))
                        .children[0],
                    ));
              }),
              ...
              (n.prototype._renderMain = function (o, t, a) {
                ...
                this.callHook("beforeEach", o, function (e) {
                  function n() {
                    (t.updatedAt &&
                      (i = Yn(i, t.updatedAt, r.config.formatUpdated)),
                  ...
                  ? (e.repo &&
                    ...
                    e.logo &&
                      ...
                      o ||
                        n ||
                        i ||
                        (e.logo = q(this.router.getBasePath(), e.logo))),
                    (f +=
                      ((i = (n = e).name || ""),
                      "<main>" +
                ...
                return (
                  ...
                  (e.prototype.initRouter = function () {
                    var n = this,
                      e = this.config,
                      e = new (
                        "history" === (e.routerMode || "hash") && t ? D : H
                      )(e);
                    ((this.router = e),
                      this.updateRender(),
                      (U = this.route),
                      e.onchange(function (e) {
                        (n.updateRender(),
                          n._updateRender(),
                          U.path !== n.route.path
                            ? (n.$fetch(d, n.$resetEvents.bind(n, e.source)),
                              (U = n.route))
